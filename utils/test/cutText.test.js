...
describe('CutText', () => {
  ...
  it('should return "content" without changes if maxLength arg is longer or equal content arg length', () => {
    expect(cutText('Lorem Ipsum', 40)).to.equal('Lorem Ipsum');
    expect(cutText('Lorem Ipsum', 11)).to.equal('Lorem Ipsum');
  });

  it('should return good cut "content" if maxLength arg is lower than content arg length', () => {
